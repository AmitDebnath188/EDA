...
from neurokit2.signal import signal_filter, signal_resample, signal_smooth


def eda_phasic(eda_signal, sampling_rate=128, method="highpass", **kwargs):
...
# Acqknowledge
# =============================================================================
def _eda_phasic_mediansmooth(eda_signal, sampling_rate=128, smoothing_factor=4):
...
def _eda_phasic_highpass(eda_signal, sampling_rate=128, cutoff=0.05):
    """One of the two methods available in biopac's acqknowledge (https://www.biopac.com/knowledge-base/phasic-eda-
    issue/)"""
