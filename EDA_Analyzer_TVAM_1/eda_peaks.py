...
from neurokit2.signal import signal_formatpeaks
from eda_findpeaks import eda_findpeaks
from eda_fixpeaks import eda_fixpeaks


def eda_peaks(eda_phasic, sampling_rate=128, method="gamboa2008", amplitude_min=0.1):
...
def _eda_peaks_getfeatures(info, eda_phasic, sampling_rate=128, recovery_percentage=0.5):
    # Sanity checks -----------------------------------------------------------
