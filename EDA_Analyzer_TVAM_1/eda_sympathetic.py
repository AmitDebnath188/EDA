...
from neurokit2.signal import signal_filter, signal_resample, signal_timefrequency
from neurokit2.signal.signal_power import _signal_power_instant_compute
from neurokit2.signal.signal_psd import _signal_psd_welch
from neurokit2.stats import standardize


def eda_sympathetic(
    eda_signal, sampling_rate=128, frequency_band=[0.045, 0.25], method="posada", show=False
):
...
def _eda_sympathetic_ghiasi(
    eda_signal, sampling_rate=128, frequency_band=[0.045, 0.25], show=True, out={}
):
